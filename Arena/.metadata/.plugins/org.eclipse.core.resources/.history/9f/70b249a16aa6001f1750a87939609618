...
public class MazeMaker extends JFrame implements KeyListener, MouseMotionListener, ActionListener{
    ...
    public static void reset(MazeMaker active)
    {
    	active.removeAll();
    	active.setVisible(false);
    	active = new MazeMaker();
    }
